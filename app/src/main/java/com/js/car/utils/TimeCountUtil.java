...
//设置按钮为灰色，这时是不能点击的
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.ic_launcher));
    ...
    public void onFinish() {
        ...
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.baoma));//还原背景色
